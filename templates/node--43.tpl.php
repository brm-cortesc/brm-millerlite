...
<?php // print $trail_blanco[1][link_title]; ?>

<?php // print $trail_blanco[1][link_path];  ?>

<?php // print $trail_blanco[2][link_title]; ?>

<?php // print $trail_blanco[2][link_path];  ?>

<?php // print $trail_blanco[3][link_title]; ?>

<?php // print $trail_blanco[3][link_path];  ?>
...
<div class="container">
    <ul class="breadcrumb">
    <li><a href="/millerlite/<?php print $trail_blanco[1][link_path];  ?>"><?php print $trail_blanco[1][link_title]; ?></a></li>
    <li><a href="/millerlite/<?php print $trail_blanco[2][link_path];  ?>"><?php print $trail_blanco[2][link_title]; ?></a></li>
    <li class="active"> <?php print $trail_blanco[3][link_title]; ?></li>
   </ul>
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3 class="slid-tit">

            <?php print strtoupper ($title); ?>
    ...
    <div class="row">
      <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 img-no-dim">
        <img src="<?php print file_create_url($node->field_imagen_html_customs[LANGUAGE_NONE][0]['uri']); ?>"  alt="<?php print $title; ?>" title="<?php print $title; ?>" >
     </div>
